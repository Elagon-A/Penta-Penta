...
- A manually armed one-row safety test invokes the retainer sale list's native slot callback once, then verifies the Adjust Price item name without requesting market data or changing a price.
