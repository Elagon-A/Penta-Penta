...
- Market searches activate the text box through the game's input manager and dispatch the Search button's registered UI event, matching real clicks end to end.
