...
- A read-only two-row calibration beside the retainer sale list records the current client's real row-selection and Compare Prices event sequence for rows 1 and 3 before retainer-native automation is enabled.
